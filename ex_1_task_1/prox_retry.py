...
class RobotController:
    ...
    def detect_obstacle(self):
        """ Function simply checks if the front three sensors are simultaneously clear or not and sets a flag."""
        ...
        front_sensors_active = (
                ...
                (0 < self.prox_data.prox_front_right <= DETECT_THRESHOLD)
                )
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Log all front sensor values for debugging
                ...
                OBSTACLE_FORWARD = self.detect_obstacle()
                ...
                # If obstacle detected, rotate away from it
                    ...
                    while OBSTACLE_FORWARD and not rospy.is_shutdown():
                        OBSTACLE_FORWARD = self.detect_obstacle()
                    ...
                    #""")
                        ...
                        if not front_sensors_active:
                            self.rotate(angular_speed=turn_direction)  # Rotate slightly more
                            rospy.loginfo("Obstacle cleared - resuming forward movement")
                            rospy.sleep(0.2)  # Buffer time
